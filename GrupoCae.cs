...
namespace ISS.Warning
{
    ...
    public partial class GrupoCae
    {
        ...
        public string IdGrupoCae { get; set; }
        public string DesignacaoGrupo { get; set; }
        public string NumGrupo { get; set; }
        public string DivisaoCaeId { get; set; }
        public Nullable<System.DateTime> DataCriacao { get; set; }
        public Nullable<System.DateTime> DataAtualizacao { get; set; }
        public string EstadoId { get; set; }
    
        public virtual DivisaoCae DivisaoCae { get; set; }
