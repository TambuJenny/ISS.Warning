...
namespace ISS.Warning
{
    ...
    public partial class TarifasPremioAutoAcidentesTrabalho
    {
        ...
        public Nullable<byte> TxDP { get; set; }
        public string Ocupantes { get; set; }
        public Nullable<double> CapitalRC { get; set; }
        public Nullable<double> PremioFixo { get; set; }
        public Nullable<double> UCF_USD { get; set; }
